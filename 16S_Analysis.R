...
#latrines 
metadata_wet2_lats<- metadata_wet2 %>% 
  filter(treatment == 'latrine')
...
#controls 
metadata_wet2_cont<- metadata_wet2 %>% 
...
simper_chronoDRGM_top10 <- simper_taxa_chronoDRGMsig %>%
  ...
  slice_head(n = 10) %>%
  ungroup()
write.csv(simper_chronoDRGM_top10, "16s_simper_chronDRGM_top10.csv", row.names = FALSE)
...
simper_chronoW_top10_lats <- simper_taxa_chronoWsig_lats %>%
  ...
  slice_head(n = 10) %>%
  ungroup()
write.csv(simper_chronoW_top10_lats, "16ssimper_chronoW_top10_lats.csv", row.names = FALSE)
...
simper_chronoW_top10_cont <- simper_taxa_chronoWsig_cont %>%
  ...
  slice_head(n = 10) %>%
  ungroup()
write.csv(simper_chronoW_top10_cont, "16s_simper_chronoW_top10_cont.csv", row.names = FALSE)
